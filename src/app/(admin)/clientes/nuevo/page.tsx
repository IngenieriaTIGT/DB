...
export default function NuevoClientePage() {
      ...
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">¡Cliente Creado!</h2>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-yellow-800">
              <strong>Importante:</strong> El cliente deberá cambiar su contraseña al iniciar sesión por primera vez.
            </p>
          </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <Link href="/clientes" className="text-blue-600 hover:text-blue-800 flex items-center gap-2 mb-4">
        ...
        <p className="text-gray-600 mt-2">Registra un nuevo cliente y genera sus credenciales de acceso</p>
      </div>
